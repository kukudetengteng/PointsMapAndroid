package cn.culturemap.pointsmap;
 ...
 */
public class PointsMapApplication extends Application {
    ...
    public void initEMChat() {
        ...
        if (processAppName == null ||!processAppName.equalsIgnoreCase("com.easemob.chatuidemo")) {
            // Log.e("PointsMapAndroidApplication initEMChat", "enter the service process!");
